...
<div class="alert alert-danger alert-danger fade show" role="alert">
  <strong>Maaf Pendaftaran Gagal</strong> Harap Isi Formulir Dengan Benar
   <a class="text-secondary text-decoration-none" href="<?php echo (base_url().'Vcontroller/index'); ?>">X
</a>    
